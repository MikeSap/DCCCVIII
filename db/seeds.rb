...
bank2 = Bank.create(name: '808')
Sound.create(bank: bank2, name: '808 Kick 1', location: './assets/sounds/TR-707Kick01.wav')
Sound.create(bank: bank2, name: '808 Snare 1', location: './assets/sounds/TR-707Snare01.wav')
Sound.create(bank: bank2, name: '808 Hat Closed', location: './assets/sounds/TR-707Hat_C.wav')
Sound.create(bank: bank2, name: '808 Hat Open', location: './assets/sounds/TR-707Hat_O.wav')
Sound.create(bank: bank2, name: '808 Crash', location: './assets/sounds/TR-707Crash.wav')
Sound.create(bank: bank2, name: '808 Ride', location: './assets/sounds/TR-707Ride.wav')
Sound.create(bank: bank2, name: '808 Tom Hi', location: './assets/sounds/TR-707Tom_Hi.wav')
Sound.create(bank: bank2, name: '808 Tom Mid', location: './assets/sounds/TR-707Tom_Mid.wav')
Sound.create(bank: bank2, name: '808 Tom Lo', location: './assets/sounds/TR-707Tom_Lo.wav')
